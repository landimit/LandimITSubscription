...
class Migration1645587089SubscriptionEmailTemplate extends MigrationStep
{
    ...
    private function createMailTemplateType(Connection $connection): string
    {
        ...
        $englishName = 'Subscription reactivate mail template type';
        $germanName = 'Abonnement-Reaktivierungs-Mail-Vorlagentyp';

        $connection->insert('mail_template_type', [
            'id' => Uuid::fromHexToBytes($mailTemplateTypeId),
            'technical_name' => 'subscription_reactivate_mail_template_type',
                            ...
                            <tbody> 
                                <tr>
                                    <td align="center">
                                        ...
                                        <v:fill type="tile" src="{{ asset('bundles/landimitsubscription/storefront/img/email/3.jpg') }}" color="#f6f8f7" />
                                        <v:textbox inset="0,0,0,0">
                                        <![endif]-->
                                        <div style="margin:auto;">
                                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="background-image:url({{ asset('bundles/landimitsubscription/storefront/img/email/3.jpg') }}); background-position:center; background-repeat:no-repeat;">
                                                <tbody> 
                                                    <tr>
                                                        <td align="center" class="res-padding">
                                                            <table align="center" border="0" cellpadding="0" cellspacing="0" class="display-width" width="600">
                                                                                                ...
                                                                                                <tbody>
                                                                                                    ...
                                                                                                    <tr>        
                                                                                                        <td align="left" class="MsoNormal" style="color:#ffffff; font-family:Segoe UI, Helvetica Neue, Arial, Verdana, Trebuchet MS, sans-serif; font-size:14px; line-height:24px; letter-spacing:1px;">
                                                                                                            We have successfully reactivated your subscription.
                                                                                                        </td>
                                                                                                    </tr>
...
Wir haben Ihr Abonnement erfolgreich reaktiviert.                                                                                                      </td>
                                                                                                    </tr>

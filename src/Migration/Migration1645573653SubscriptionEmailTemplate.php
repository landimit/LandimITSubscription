...
class Migration1645573653SubscriptionEmailTemplate extends MigrationStep
{
    ...
    private function createMailTemplateType(Connection $connection): string
    {
        ...
        $englishName = 'Subscription cancel mail template type';
        $germanName = 'E-Mail-Vorlagentyp für die Kündigung des Abonnements';

        $connection->insert('mail_template_type', [
            'id' => Uuid::fromHexToBytes($mailTemplateTypeId),
            'technical_name' => 'subscription_cancel_mail_template_type',
    ...
    private function createMailTemplateNew(Connection $connection, string $mailTemplateTypeId): void
    {
        ...
        $connection->insert('mail_template_translation', [
            ...
            'language_id' => $deLangId,
            'sender_name' => '{{ salesChannel.name }}',
            'subject' => 'Ihr Abonnement wurde gekündigt.',
                            ...
                            <tbody> 
                                <tr>
                                    <td align="center">
                                        ...
                                        <v:fill type="tile" src="{{ asset('bundles/landimitsubscription/storefront/img/email/1.jpg') }}" color="#f6f8f7" />
                                        <v:textbox inset="0,0,0,0">
                                        <![endif]-->
                                        <div style="margin:auto;">
                                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="background-image:url({{ asset('bundles/landimitsubscription/storefront/img/email/1.jpg') }}); background-position:center; background-repeat:no-repeat;">
                                                <tbody> 
                                                    <tr>
                                                        <td align="center" class="res-padding">
                                                            <table align="center" border="0" cellpadding="0" cellspacing="0" class="display-width" width="600">
                                                                                                ...
                                                                                                <tbody>
                                                                                                    ...
                                                                                                    <tr>        
                                                                                                        <td align="left" class="MsoNormal" style="color:#ffffff; font-family:Segoe UI, Helvetica Neue, Arial, Verdana, Trebuchet MS, sans-serif; font-size:14px; line-height:24px; letter-spacing:1px;">
                                                                                                            We have successfully canceled your subscription.If you have any questions about your subscription, please don't hesitate to contact us.
                                                                                                        </td>
                                                                                                    </tr>
                                                                                        ...
                                                                                        <td align="center">
                                                                                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="85%" style="width:85% !important;">
                                                                                                <tbody>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td align="left" class="Heading" style="color:#ffffff; font-family:Segoe UI, Helvetica Neue, Arial, Verdana, Trebuchet MS, sans-serif; font-weight:700; text-transform:uppercase; font-size:30px; line-height:40px; letter-spacing:1px;">
                                                                                                            Es tut uns leid, dass Sie uns verlassen.
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td height="15"></td>
...
Wir haben Ihr Abonnement erfolgreich gekündigt. Wenn Sie Fragen zu Ihrem Abonnement haben, zögern Sie bitte nicht, uns zu kontaktieren.                                                                                                        </td>
                                                                                                    </tr>

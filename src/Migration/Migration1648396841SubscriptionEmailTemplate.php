...
class Migration1648396841SubscriptionEmailTemplate extends MigrationStep
{
    ...
    private function createMailTemplateType(Connection $connection): string
    {
        ...
        $englishName = 'Subscription payment failed mail template type';
        $germanName = 'E-Mail-Vorlagentyp für Abonnementzahlung fehlgeschlagen';

        $connection->insert('mail_template_type', [
            'id' => Uuid::fromHexToBytes($mailTemplateTypeId),
            'technical_name' => 'subscription_payment_failed_mail_template_type',
    ...
    private function createMailTemplateNew(Connection $connection, string $mailTemplateTypeId): void
    {
        ...
        $connection->insert('mail_template_translation', [
            ...
            'subject' => 'Payment failed in your subscription renew.',
            'description' => 'Payment failed in your subscription renew.',
        ...
        $connection->insert('mail_template_translation', [
            ...
            'language_id' => $deLangId,
            'sender_name' => '{{ salesChannel.name }}',
            'subject' => 'Die Zahlung ist bei der Verlängerung Ihres Abonnements fehlgeschlagen.',
            'description' => 'Die Zahlung ist bei der Verlängerung Ihres Abonnements fehlgeschlagen.',
                                                ...
                                                <tr>
                                                    <td align="center" valign="middle">
                                                        <a href="#" style="color:#666666;text-decoration:none;">
                                                            <img src="{{ asset('bundles/landimitsubscription/storefront/img/email/logo.png') }}" width="150" style="margin:0; border:0; padding:0; display:block; border-radius:3px;" />
                                                        </a>
                                                    </td>
                                                </tr>                                               
                                            </table>
                            ...
                            <tbody> 
                                <tr>
                                    <td align="center">
                                        ...
                                        <v:fill type="tile" src="{{ asset('bundles/landimitsubscription/storefront/img/email/4.jpg') }}" color="#f6f8f7" />
                                                        ...
                                                        <td align="center" class="res-padding">
                                                            <table align="center" border="0" cellpadding="0" cellspacing="0" class="display-width" width="600">
                                                                <tbody>
                                                                    <tr>
                                                                        <td align="left">
                                                                            <table align="left" bgcolor="#c46414" border="0" cellpadding="0" cellspacing="0" class="header1" width="100%">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td height="120"></td>
                                                                                    </tr>
                                                                                                ...
                                                                                                <tbody>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td align="left" class="Heading" style="color:#ffffff; font-family:Segoe UI, Helvetica Neue, Arial, Verdana, Trebuchet MS, sans-serif; font-weight:700; text-transform:uppercase; font-size:30px; line-height:40px; letter-spacing:1px;">
                                                                                                            The payment for this subscription has been been declined.
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td height="15"></td>
                                                                                                    ...
                                                                                                    <tr>        
                                                                                                        <td align="left" class="MsoNormal" style="color:#ffffff; font-family:Segoe UI, Helvetica Neue, Arial, Verdana, Trebuchet MS, sans-serif; font-size:14px; line-height:24px; letter-spacing:1px; ">
                                                                                                            Please, go to your account or 
                                                                                                            <a href="{{ url }}{{ path('frontend.account.subscription.page') }}" style="color: #fff;">Click here!</a>
                                                                                                        </td>
                                                                                                    </tr>
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td align="left" width="150">
                                                                                    <img src="{{ lineItem.product.cover.media.url }}" width="282" style="color:#333333; border:0; margin:0; padding:0; border-radius:5px; width:100%; height:auto;" />
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>    
                                                                    </table>
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td align="left" valign="middle" style="color:#333333;">
                                                                                                    <img src="{{ asset('bundles/landimitsubscription/storefront/img/email/logo2.png') }}"  width="150" style="border:0; margin:0; padding:0;" />
                                                                                                </td>
                                                                                            </tr>
                                                                                        </tbody>    
                                                                                    </table>
                                                                                        ...
                                                                                        <td align="center">
                                                                                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="85%" style="width:85% !important;">
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td align="left" class="Heading" style="color:#ffffff; font-family:Segoe UI, Helvetica Neue, Arial, Verdana, Trebuchet MS, sans-serif; font-weight:700; text-transform:uppercase; font-size:14px; line-height:24px; letter-spacing:1px;">
                                                                                                            Die Verlängerung des Abonnements ist fehlgeschlagen
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td height="5"></td>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td align="left" class="Heading" style="color:#ffffff; font-family:Segoe UI, Helvetica Neue, Arial, Verdana, Trebuchet MS, sans-serif; font-weight:700; text-transform:uppercase; font-size:30px; line-height:40px; letter-spacing:1px;">
                                                                                                            Die Zahlung für dieses Abonnement wurde abgelehnt.
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td height="15"></td>
                                                                                                    ...
                                                                                                    <tr>        
                                                                                                        <td align="left" class="MsoNormal" style="color:#ffffff; font-family:Segoe UI, Helvetica Neue, Arial, Verdana, Trebuchet MS, sans-serif; font-size:14px; line-height:24px; letter-spacing:1px;">
                                                                                                                Bitte gehen Sie zu Ihrem Konto bzw 
                                                                                                                <a href="{{ url }}{{ path('frontend.account.subscription.page') }}" style="color: #fff;"> Klick hier!</a>
                                                                                                            </td>
                                                                                                    </tr>
                                                                ...
                                                                <td align="left">
                                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="width:auto !important;">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td align="left" width="150">
                                                                                    <img src="{{ lineItem.product.cover.media.url }}" 
                                                                                        width="282" 
                                                                                        style="color:#333333; border:0; margin:0; padding:0; border-radius:5px; width:100%; height:auto;" />
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>    
                                                                    </table>
